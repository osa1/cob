...
(function() {
  ...
  var lastTime = 0,
    requestAnimationFrame = window.requestAnimationFrame || window.msRequestAnimationFrame || window.mozRequestAnimationFrame || window.webkitRequestAnimationFrame || window.oRequestAnimationFrame ||
  function(callback) {
...
(function() {
  ...
  var createInstance = function(sound) {
      ...
      sound.el.cloneNode(true), function() {
...
(function() {
  ...
  Luv.Graphics.SpriteSheet = Luv.Class('Luv.Graphics.SpriteSheet', {
    ...
    Sprite: function(x, y) {
      ...
      this.image, this.left + this.width * x + this.border * (x + 1), this.top + this.height * y + this.border * (y + 1), this.width, this.height);
    },
